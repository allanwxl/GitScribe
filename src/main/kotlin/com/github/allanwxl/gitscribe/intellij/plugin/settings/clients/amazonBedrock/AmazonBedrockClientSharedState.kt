package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.amazonBedrock
...
@State(name = "AmazonBedrockClientSharedState", storages = [Storage("GitScribeAmazonBedrock.xml")])
