...
import com.github.allanwxl.gitscribe.intellij.plugin.*
...
class PromptTable(private val cs: CoroutineScope) {
    ...
    private class PromptDialog(val prompts: Set<String>, private val cs: CoroutineScope, val newPrompt: Prompt? = null) : DialogWrapper(true) {
        ...
        private fun setPreview(promptContent: String, hint: String, numberOfPreviousCommitMessages: Int) = cs.launch(Dispatchers.IO + ModalityState.stateForComponent(rootPane).asContextElement()) {
            ...
            val constructPrompt = GitScribeUtils.constructPrompt(promptContent, diff, branch, hint, previousCommitMessages, project)
