package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.mistral
...
@State(name = "MistralAIClientSharedState", storages = [Storage("GitScribeMistralAI.xml")])
