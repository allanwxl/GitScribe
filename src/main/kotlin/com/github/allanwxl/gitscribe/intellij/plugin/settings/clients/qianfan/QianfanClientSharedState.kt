package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.qianfan
...
@State(name = "QianfanClientSharedState", storages = [Storage("GitScribeOpenAi.xml")])
