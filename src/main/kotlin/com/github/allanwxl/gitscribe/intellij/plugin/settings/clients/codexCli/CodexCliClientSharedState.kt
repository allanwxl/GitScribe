package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.codexCli
...
@State(name = "CodexCliClientSharedState", storages = [Storage("GitScribeCodexCli.xml")])
