...
import com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.LlmClientTable
import com.github.allanwxl.gitscribe.intellij.plugin.settings.prompts.Prompt
import com.github.allanwxl.gitscribe.intellij.plugin.settings.prompts.PromptTable
...
class AppSettingsConfigurable(val project: Project, cs: CoroutineScope) : BoundConfigurable(message("settings.general.group.title")) {
    ...
    override fun createPanel() = panel {
        ...
        row {
            ...
            llmClientConfigurationComboBox = comboBox(AppSettings2.instance.llmClientConfigurations.sortedBy { it.name }, GitScribeListCellRenderer())
        ...
        row {
            ...
            val ideLocale = GitScribeUtils.getIDELocale()
        ...
        row {
            ...
            promptComboBox = comboBox(AppSettings2.instance.prompts.values, GitScribeListCellRenderer())
        ...
        row {
            browserLink(message("settings.report-bug"), GitScribeBundle.URL_BUG_REPORT.toString())
            browserLink(message("settings.github-star"), GitScribeBundle.URL_GITHUB.toString())
        }
    }
