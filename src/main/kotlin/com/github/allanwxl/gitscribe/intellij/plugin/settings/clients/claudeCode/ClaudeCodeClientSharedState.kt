package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.claudeCode
...
@State(name = "ClaudeCodeClientSharedState", storages = [Storage("GitScribeClaudeCode.xml")])
