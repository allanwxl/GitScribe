package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.anthropic
...
@State(name = "AnthropicClientSharedState", storages = [Storage("GitScribeAnthropic.xml")])
