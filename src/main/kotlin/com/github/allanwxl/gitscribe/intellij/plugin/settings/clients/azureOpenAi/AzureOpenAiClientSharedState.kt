package com.github.allanwxl.gitscribe.intellij.plugin.settings.clients.azureOpenAi
...
@State(name = "AzureOpenAiClientSharedState", storages = [Storage("GitScribeAzureOpenAi.xml")])
