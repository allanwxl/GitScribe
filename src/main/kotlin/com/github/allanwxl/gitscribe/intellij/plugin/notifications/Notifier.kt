package com.github.allanwxl.gitscribe.intellij.plugin.notifications
...
private const val IMPORTANT_GROUP_ID = "gitscribe.notification.important"
private const val GENERAL_GROUP_ID = "gitscribe.notification.general"
...
fun sendNotification(notification : Notification, project : Project? = null) {
    ...
    intellijNotification.icon = Icons.GITSCRIBE.getThemeBasedIcon()
